        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div  class="col-md-6"><img style="height: 450px; width: 300px" class="card-img-top mb-5 mb-md-0" src="${product.imageUrl}" alt="..." /></div>
                    <div class="col-md-6">
                        ...
                        <div class="fs-5 mb-5">
                            ...
                            <span ><i class="bi bi-tags-fill">$ ${product.price} </i></span> <br>
                            <br>
                            <span><i class="bi bi-house-fill"> ${product.description}</i></span> 
                        </div>
